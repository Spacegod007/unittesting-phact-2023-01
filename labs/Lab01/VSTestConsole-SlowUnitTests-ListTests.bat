...
CD C:\Course\Labs\Lab01\SlowUnitTests\bin\Debug
%VSPATH%\vstest.console.exe SlowUnitTests.A.dll SlowUnitTests.B.dll SlowUnitTests.C.dll /ListTests /TestAdapterPath:"." 
