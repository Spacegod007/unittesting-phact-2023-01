namespace BowlingGame
{
	public class Game
	{
		...
		{
			if (!IsLegalRoll(pinsDown)) throw new
			  System.ArgumentOutOfRangeException("May only knock down 0-10 pins.");
			_rolls[_currentRoll] = pinsDown;
			_currentRoll++;
		}

		private bool IsLegalRoll(int pinsDown)
		{
			return pinsDown <= 10 && pinsDown >= 0;
		}
