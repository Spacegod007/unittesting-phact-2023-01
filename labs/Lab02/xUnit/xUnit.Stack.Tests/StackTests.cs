...
namespace xUnitSample
{
	...
	public class StackTests
	{
		...
		public class EmptyStack
		{
			...
			[Fact]
			public void Peek_ShouldThrowInvalidOperationException_Sleep()
			{
				Exception exception = Record.Exception(() => stack.Peek());
		...
		public class StackWithOneElement
		{
			...
			[Fact]
			public void Peek_ShouldReturnPushedValue_Sleep()
			{
				int actual = stack.Peek();
				System.Threading.Thread.Sleep(1000);
				Assert.Equal(pushedValue, actual);
		...
		[Trait("Stack Type", "Multiple Values")]
		public class StackWithMultipleValues
		{
			...
			[Fact]
			public void Contains_ReturnsTrue_Sleep()
			{
				bool contains = stack.Contains(secondPushedValue);
				System.Threading.Thread.Sleep(1000);
				Assert.True(contains);
		...
		public class StackWithStrings
		{
			...
			[Fact]
			public void Pop_ShouldReturnPushedValue_Sleep()
			{
				Stack<string> stack = new Stack<string>();
				stack.Push("Help");
